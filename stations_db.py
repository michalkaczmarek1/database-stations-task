...
if __name__ == "__main__":
    ...
    conn.execute(ins_clean_meas, [
        {'station': 'USC00519397', 'date': datetime.datetime(2010,1,1), 'precip': 0.08, 'tobs': 65},
        {'station': 'USC00519397', 'date': datetime.datetime(2010,1,2), 'precip': 0.0, 'tobs': 63},
        {'station': 'USC00519397', 'date': datetime.datetime(2010,1,3), 'precip': 0.0, 'tobs': 74},
        {'station': 'USC00519397', 'date': datetime.datetime(2010,1,4), 'precip': 0.0, 'tobs': 76},
        {'station': 'USC00519397', 'date': datetime.datetime(2010,1,6), 'precip': 0.0, 'tobs': 73},
        {'station': 'USC00519397', 'date': datetime.datetime(2010,1,7), 'precip': 0.06, 'tobs': 70},
        {'station': 'USC00519523', 'date': datetime.datetime(2016,3,28), 'precip': 0.0, 'tobs': 73},
        {'station': 'USC00519523', 'date': datetime.datetime(2016,3,29), 'precip': 0.04, 'tobs': 75},
        {'station': 'USC00519281', 'date': datetime.datetime(2012,9,25), 'precip': 0.05, 'tobs': 74},
        {'station': 'USC00519281', 'date': datetime.datetime(2012,9,26), 'precip': 0.02, 'tobs': 74}
    ])
